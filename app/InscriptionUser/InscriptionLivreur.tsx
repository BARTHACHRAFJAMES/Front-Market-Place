...
export default function InscriptionLivreur(props: any) {
      ...
      <SafeAreaView style={styles.container}>
         ...
         <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 300 }}>
            ...
            <View style={styles.Tete}>
               <Ionicons name='bicycle-outline' style={styles.person}/>
               <Text style={styles.title}>Inscription de livreur</Text>
            </View>
