...
export default function InscriptionFournisseur(props: any) {
      ...
      <SafeAreaView style={styles.container}>
         ...
         <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 300 }}>
            ...
            <View style={styles.Tete}>
               <Ionicons name='storefront-outline' style={styles.person}/>
               <Text style={styles.title}>Inscription de fournisseur</Text>
            </View>
